...
function get_sets()
    ...
    sets.Idle = {           ammo="staunch tathlum +1",
							...
							back="Moonlight Cape",}
    sets.Idle.Raetic = set_combine(sets.Idle,{
            main="Raetic"})
    sets.Idle.Raetic.SAM = set_combine(sets.Idle,{
            main="Raetic"})
    ...
    sets.Idle.Regen.Raetic = set_combine(sets.Idle.Regen,{
            main="Raetic"})
    sets.Idle.Regen.Raetic.SAM = set_combine(sets.Idle.Regen,{
            main="Raetic"})
    ...
    sets.Idle.Movement = set_combine(sets.Idle.Regen,{
            legs="Carmine Cuisses +1"})
    sets.Idle.Movement.Raetic = set_combine(sets.Idle.Movement,{
            main="Raetic"})
    sets.Idle.Movement.Raetic.SAM = set_combine(sets.Idle.Movement,{
            main="Raetic"})
    ...
    sets.Idle.Refresh = set_combine(sets.Idle.Regen,{
            neck="Bale choker",
            body="Lugra Cloak +1",})
    sets.Idle.Refresh.Raetic = set_combine(sets.Idle.Refresh,{
            main="Raetic"})
    sets.Idle.Refresh.Raetic.SAM = set_combine(sets.Idle.Refresh,{
            main="Raetic"})
    ...
    sets.Idle.Regain.Raetic = set_combine(sets.Idle.Regain,{
            main="Raetic"})
    sets.Idle.Regain.Raetic.SAM = set_combine(sets.Idle.Regain,{
            main="Raetic"})
    ...
    -- Raetic TP Sets --
    sets.TP.Raetic = {--217TP/hit 1140cu
                            main="Raetic",
                            ammo="Ginsen",
							sub="Utu Grip",
    ...
    -- Raetic(AM Down: SAM Roll) TP Sets --
    sets.TP.Raetic.STP = {--270tp/hit Accu1117
							main="Raetic",
    						sub="Utu Grip",
    						ammo="Ginsen",
							head={ name="Argosy Celata +1", augments={'DEX+12','Accuracy+20','"Dbl.Atk."+3',}},
    ...
    sets.TP.Raetic.SAM.STP = {--avec SAM Roll 7 >> 268tp/hit 1139Accu
                            main="Raetic",
                            sub="Utu Grip",	
							ammo="Ginsen",
							head="Flam. Zucchetto +2",
    ...
    sets.TP.Raetic.SAM.HighACC.STP = {
                            main="Raetic",
                            sub="Utu Grip",	
                            ammo="Seeth. Bomblet +1",
                            head="Ig. Burgonet +3",
