...
function user_setup()
    ...
    send_command('bind NUMPAD1 input /ja "Double-up" <me>')
    send_command('bind ^NUMPAD1 input /ja "Crooked Cards" <me>')
    send_command('bind NUMPAD2 input /ja "Snake Eye" <me>')
	send_command('bind ^NUMPAD2 input /ja "Triple Shot" <me>')
    send_command('bind NUMPAD3 input /ja "Fold" <me>')
    send_command ('bind ^NUMPAD0 gs c toggle LuzafRing')

    send_command('bind = gs c cycle mainqd')
    send_command('bind != gs c cycle altqd')
    send_command('bind ^m gs c toggle selectqdtarget')
    ...
    send_command('bind numpad7 input /ws "Fast Blade" <t>')
    send_command('bind numpad5 input /ws "Last Stand" <t>')
	...
	send_command('bind ^numpad0 input /ja "Thunder Shot" <t>')
