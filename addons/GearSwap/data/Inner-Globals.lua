...
function define_global_sets()
    ...
    gear.Herc_MAB_legs = { name="Herculean Trousers", augments={'Mag. Acc.+15 "Mag.Atk.Bns."+15','STR+1','"Mag.Atk.Bns."+14',}}
    ...
    gear.Taeon_RA_head = { name="Taeon Chapeau", augments={'"Snapshot"+4','"Snapshot"+4',}}
    ...
    gear.COR_SNP_Cape = {name="Camulus's Mantle", augments={'INT+20','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','"Snapshot"+10','Phys. dmg. taken-10%',}} --*
    gear.COR_TP_Cape = {name="Camulus's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Phys. dmg. taken-10%',}} --**
    gear.COR_WS1_Cape = {name="Camulus's Mantle", augments={'AGI+20','Mag. Acc+20 /Mag. Dmg.+20','Weapon skill damage +10%',}} --* 
