...
function init_gear_sets()
    ...
    sets.precast.JA['Shield Bash'] = set_combine(sets.precast.JA['Provoke'], {sub="Aegis", hands="Cab. Gauntlets +3", left_ear="Knightly Earring", left_ring="Guardian's Ring",right_ring="Fenian Ring"})
...
{	
    ...
    --Stat Modifier: WS damage + 62/81   2273DMG maxaggro
	...
	sets.midcast['Bomb Toss'] = 
{
    ...
    sets.Doom = {neck="Nicander's Necklace", legs="Shabti Cuisses +1",left_ring="Eshmun's Ring",right_ring="Eshmun's Ring", waist="Gishdubar Sash"} -- +85%
