...
function get_sets()
	...
	send_command('bind NUMPAD1 input /stun <stnpc>')
	send_command('bind NUMPAD2 input /endark2')
	send_command('bind NUMPAD3 input /dread spikes')
	send_command('bind NUMPAD4 input /ws catastrophe')
	send_command('bind ^NUMPAD4 input /ws "Spinning Scythe"')
	send_command('bind NUMPAD5 input /ws cross reaper')
	send_command('bind NUMPAD6 input /ws entropy')
	send_command('bind NUMPAD7 input /ws torcleaver')
	send_command('bind NUMPAD8 input /ws insurgency')
	send_command('bind NUMPAD9 input /ws quietus')
	send_command('bind NUMPAD0 input /equip main Apocalypse')
	send_command('bind ^NUMPAD0 input /equip main "Raetic Algol +1"')
    ...
    -- Catastrophe Sets --
    sets.WS = {
	ammo="Knobkierrie", --"Knobkierrie"
    head={ name="Valorous Mask", augments={'Attack+1','Weapon skill damage +5%','DEX+9',}},
    body="Ignominy Cuirass +3",
    hands={ name="Odyssean Gauntlets", augments={'Attack+26','Weapon skill damage +5%',}},
    ...
    back={ name="Ankou's Mantle", augments={'VIT+20','Accuracy+20 Attack+20','VIT+6','Weapon skill damage +10%',}},
	}
...
sets.JA = {}
	...
	sets.Midcast['Drain III'] = {
							...
							head={ name="Fall. Burgeonet", augments={'Enhances "Dark Seal" effect',}},
