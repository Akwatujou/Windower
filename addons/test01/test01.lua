...
function go()
        local p = packets.new('outgoing', 0x050, {
		['a'] = 4,
		['b'] = 54,		
		['c'] = 13,
		['ItemID'] = 60,
...
function exitArena()
	...
	if player.vitals.hp == 0 then
		...
		log("Fight's over, teleporting in 1 minutes.")
		coroutine.sleep(60)
...
function enterReisen()
	...
	log('Entering Reisenjima in 5 minute.')
...
function moveToLocation()
	...
	coroutine.sleep(8)
	windower.send_command('input /ma "August" <me>')
	coroutine.sleep(8)
